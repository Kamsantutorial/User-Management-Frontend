<template>
  <BaseComponent
    ...
    v-if="
      hasAccess('VIEW_PERMISSION') ||
      hasAccess('CREATE_PERMISSION') ||
      hasAccess('UPDATE_PERMISSION')
    "
  >
    <template #header>
      <a-row>
      ...
      <a-row>
        <a-row class="row-layout">
          ...
          <a-col class="second-col-layout">
            <a-form-item
              v-bind="validateInfos.permission_name"
          ...
          <a-col style="width: 35%">
            <a-form-item>
              <a-select ref="select" v-model:value="menuObject" @change="selectChange">
                <a-select-option v-for="menu in menus" :key="menu.id" :value="menu.id">{{
                  menu.menu_name
                }}</a-select-option>
              </a-select>
            </a-form-item>
        ...
        <a-row class="row-layout">
          ...
          <a-col style="width: 35%">
            <a-form-item>
              <a-switch
                v-model:checked="status.is_active"
    ...
    <template #formUpdate>
      ...
      <a-row style="margin-left: 30%">
        <a-col
          ><a-button type="primary" @click.prevent="onSubmit" v-if="hasAccess('UPDATE_PERMISSION')"
            >Save</a-button
          ></a-col
        >
        <a-col><a-button style="margin-left: 10px" @click="back()">Back</a-button></a-col>
    ...
    <template #detail>
      <a-descriptions>
        ...
        <a-descriptions-item label="Permission Name">{{
...
import type {
  PermissionModel,
  PermissionFilter
} from '@/components/setting/permission/PermissionModel'
import {
